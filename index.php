...
<body>
                    ...
                    <div class="card-body p-4">
                        <form class="needs-validation" novalidate>
                            <div class="form-group">
                                ...
                                <input type="text" name="mls_number" id="mls_number" class="form-control"
                                    id="mls_number" required autocomplete="off">
                            </div>
                                    ...
                                    <div class="form-group mb-4 col-xl-12 col-md-12 col-sm-12 col-12">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="names[]" id="name0"
                                                class="form-control inputCustomerName" required autocomplete="off">
                                            <button type="button" class="btn btn-success" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title=""
                                                onclick="addInputCustomer(); setOldValuesInputCustomers();"><i
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="price" id="price" class="form-control" placeholder="Price"
                                        aria-describedby="price" required min="0"
                                        oninput="price_input(); commas_number_input(price);" autocomplete="off"
                                        inputmode="numeric">
                                </div>
                            </div>
                            <div class="form-group mb-4" id="divDeposit">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="deposit" id="deposit" class="form-control"
                                        placeholder="Deposit" aria-label="Deposit" aria-describedby="deposit" required
                                        min="0" oninput="commas_number_input(deposit);" autocomplete="off"
                                        inputmode="numeric">
                                </div>
                            </div>
                            <div class="form-group mb-4">
                                <label for="inputDate" class="form-label" id="labelDate"></label>
                                <input type="text" inputmode="none" id="inputDate" autocomplete="off"
                                    class="form-control bg-white" placeholder="Date" required>
                            </div>
                            <div class="d-grid gap-2 mt-4">
                                <button class="btn btn-primary btnSubmit" type="submit">Next</button>
                                <button class="btn" type="button" onclick="backPreviousForm();"
                                    style="color: #A9A9A9;">Back</button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <form class="needs-validation" novalidate>
                        <div id="divLegalDescriptionCondo" class="mb-4">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-3">
                                    <input type="text" name="legal_description_condo_unit"
                                        id="legal_description_condo_unit" class="form-control" autocomplete="off">
                                </div>
                            </div>
                            <div class="row">
                                <label for="legal_description_condo_level" class="col-3 col-form-label">LEVEL</label>
                                <div class="col-3">
                                    <input type="text" name="legal_description_condo_level"
                                        id="legal_description_condo_level" class="form-control" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div id="divLegalDescriptionParkingSpot">
                            <div class="row rowParkingSpot">
                                <div class="col-12">
                                    <div class="form-group mb-4">
                                        <label for="" class="form-label labelParkingSpot"><strong>Legal</strong>
                                            Description of Parking Spot</label>
                                        <div class="row mb-2">
                                            <label for="legal_description_parking_spot_unit_0"
                                                class="col-3 col-form-label">UNIT</label>
                                            <div class="col-3">
                                                <input type="text" name="legal_description_parking_spot_unit"
                                                    id="legal_description_parking_spot_unit_0" class="form-control"
                                                    autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label for="legal_description_parking_spot_level"
                                                class="col-3 col-form-label">LEVEL</label>
                                            <div class="col-3">
                                                <input type="text" name="legal_description_parking_spot_level"
                                                    id="legal_description_parking_spot_level" class="form-control"
                                                    autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="divLegalDescriptionLocker" class="mb-4">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-3">
                                    <input type="text" name="legal_description_locker_unit"
                                        id="legal_description_locker_unit" class="form-control" autocomplete="off">
                                </div>
                            </div>
                            <div class="row">
                                <label for="legal_description_locker_level" class="col-3 col-form-label">LEVEL</label>
                                <div class="col-3">
                                    <input type="text" name="legal_description_locker_level"
                                        id="legal_description_locker_level" class="form-control" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-4" id="divLegalDescriptionProperty">
                            <label for="legal_description_property" class="form-label">What is the Legal Description of
                                the Property?</label>
                            <textarea name="legal_description_property" id="legal_description_property" rows="4"
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="finance_condition" id="no_finance_condition"
                                                value="No Finance Condition" class="form-check-input"
                                                onchange="displayForm()">
                                            <label for="no_finance_condition" class="form-check-label">No Finance
                                                Condition</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="finance_condition" id="finance_one_business_day"
                                                value="One Business Day" class="form-check-input"
                                                onchange="displayForm()">
                                            <label for="finance_one_business_day" class="form-check-label">One Business
                                                Day</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="finance_condition" id="finance_two_business_days"
                                                value="Two Business Days" class="form-check-input"
                                                onchange="displayForm()">
                                            <label for="finance_two_business_days" class="form-check-label">Two Business
                                                Days</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="finance_condition"
                                                id="finance_three_business_days" value="Three Business Days"
                                                class="form-check-input" onchange="displayForm()">
                                            <label for="finance_three_business_days" class="form-check-label">Three
                                                Business Days</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="finance_condition" id="finance_four_business_days"
                                                value="Four Business Days" class="form-check-input"
                                                onchange="displayForm()">
                                            <label for="finance_four_business_days" class="form-check-label">Four
                                                Business Days</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="finance_condition" id="finance_five_business_days"
                                                value="Five Business Days" class="form-check-input"
                                                onchange="displayForm()">
                                            <label for="finance_five_business_days" class="form-check-label">Five
                                                Business Days</label>
                                        </div>
                                    </li>
                                </ul>
                        ...
                        <div class="card my-4">
                            <div class="card-body p-0">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="status_review_condition"
                                                id="no_status_review_condition" value="No Status Review Condition"
                                                class="form-check-input" onchange="displayForm()">
                                            <label for="no_status_review_condition" class="form-check-label">No Status
                                    ...
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="status_review_condition"
                                                id="status_review_one_business_day" value="One Business Day"
                                                class="form-check-input" onchange="displayForm()">
                                            <label for="status_review_one_business_day" class="form-check-label">One
                                                Business Day</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="status_review_condition"
                                                id="status_review_two_business_days" value="Two Business Days"
                                                class="form-check-input" onchange="displayForm()">
                                            <label for="status_review_two_business_days" class="form-check-label">Two
                                                Business Days</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="status_review_condition"
                                                id="status_review_three_business_days" value="Three Business Days"
                                                class="form-check-input" onchange="displayForm()">
                                            <label for="status_review_three_business_days"
                                                class="form-check-label">Three Business Days</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="status_review_condition"
                                                id="status_review_four_business_days" value="Four Business Days"
                                                class="form-check-input" onchange="displayForm()">
                                            <label for="status_review_four_business_days" class="form-check-label">Four
                                                Business Days</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="status_review_condition"
                                                id="status_review_five_business_days" value="Five Business Days"
                                                class="form-check-input" onchange="displayForm()">
                                            <label for="status_review_five_business_days" class="form-check-label">Five
                                                Business Days</label>
                                        </div>
                                    </li>
                                </ul>
                        ...
                        <div class="card my-4">
                            <div class="card-body p-0">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="inspection_condition" id="no_inspection_condition"
                                                value="No Inspection Condition" class="form-check-input"
                                                onchange="displayForm();">
                                            <label for="no_inspection_condition" class="form-check-label">No Inspection
                                                Condition</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="inspection_condition"
                                                id="inspection_one_business_day" value="One Business Day"
                                                class="form-check-input" onchange="displayForm();">
                                            <label for="inspection_one_business_day" class="form-check-label">One
                                                Business Day</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="inspection_condition"
                                                id="inspection_two_business_days" value="Two Business Days"
                                                class="form-check-input" onchange="displayForm();">
                                            <label for="inspection_two_business_days" class="form-check-label">Two
                                                Business Days</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="inspection_condition"
                                                id="inspection_three_business_days" value="Three Business Days"
                                                class="form-check-input" onchange="displayForm();">
                                            <label for="inspection_three_business_days" class="form-check-label">Three
                                                Business Days</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="inspection_condition"
                                                id="inspection_four_business_days" value="Four Business Days"
                                                class="form-check-input" onchange="displayForm();">
                                            <label for="inspection_four_business_days" class="form-check-label">Four
                                                Business Days</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="radio" name="inspection_condition"
                                                id="inspection_five_business_days" value="Five Business Days"
                                                class="form-check-input" onchange="displayForm()">
                                            <label for="inspection_five_business_days" class="form-check-label">Five
                                                Business Days</label>
                                        </div>
                                    </li>
                                </ul>
                        ...
                        <div class="card my-4">
                            <div class="card-body p-0">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="checkbox" name="chattels" id="chattel_1"
                                                class="form-check-input" onclick="changeSelectionBorderColor(this)"
                                                value="Stainless Steel Fridge/Freezer">
                                            <label for="chattel_1" class="form-check-label">Stainless Steel
                                                Fridge/Freezer</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="checkbox" name="chattels" id="chattel_2"
                                                class="form-check-input" onclick="changeSelectionBorderColor(this)"
                                                value="Stainless Steel Over-the-Range Microwave with Built in Exhaust Fan">
                                            <label for="chattel_2" class="form-check-label">Stainless Steel
                                                Over-the-Range Microwave with Built in Exhaust Fan</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="checkbox" name="chattels" id="chattel_3"
                                                class="form-check-input" onclick="changeSelectionBorderColor(this)"
                                                value="Stainless Steel Dishwasher">
                                            <label for="chattel_3" class="form-check-label">Stainless Steel
                                                Dishwasher</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="checkbox" name="chattels" id="chattel_4"
                                                class="form-check-input" onclick="changeSelectionBorderColor(this)"
                                                value="Stainless Steel Oven With Electric Range">
                                            <label for="chattel_4" class="form-check-label">Stainless Steel Oven With
                                                Electric Range</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="checkbox" name="chattels" id="chattel_5"
                                                class="form-check-input" onclick="changeSelectionBorderColor(this)"
                                                value="Stacked Front Loading Washer & Dryer">
                                            <label for="chattel_5" class="form-check-label">Stacked Front Loading Washer
                                                & Dryer</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="checkbox" name="chattels" id="chattel_6"
                                                class="form-check-input" onclick="changeSelectionBorderColor(this)"
                                                value="All Electric Light Fixtures">
                                            <label for="chattel_6" class="form-check-label">All Electric Light
                                                Fixtures</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check">
                                            <input type="checkbox" name="chattels" id="chattel_7"
                                                class="form-check-input" onclick="changeSelectionBorderColor(this)"
                                                value="All Existing Window Coverings">
                                            <label for="chattel_7" class="form-check-label">All Existing Window
                                                Coverings</label>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="form-check" id="form_chattel_order">
                                            <input type="checkbox" name="chattels" id="chattel_other"
                                                class="form-check-input" onclick="changeSelectionBorderColor(this)"
                                                value="">
                                            <label for="chattel_other" class="form-check-label w-100 fw-bold"
                                                id="label_chattel_other">+ Add Custom Chattels</label>
                                        </div>
                                    </li>
                                </ul>
                            </div>
    ...
    <div class="row justify-content-center d-none" id="form_booster">
            ...
            <div class="card">
                <div class="card-body p-4 d-flex justify-content-center flex-column">
                    <div class="alert alert-primary text-center" role="alert">
                        Auto-populated information is provided solely for your convenience and Fast Offers disclaims any
                        representation as to the accuracy or completeness of this information. <br><br><span
                    ...
                    <button class="btn btn-primary d-block" onclick="location.href = 'index.php';">Draft Another
                        Offer</button>
                </div>
            </div>
        </div>
    ...
    var form_booster = document.getElementById('form_booster');
    ...
    var listing_agent = document.getElementById('listing_agent');
    ...
    chattel_other.onchange = function() {
        if (this.checked == true) {
            label_chattel_other.innerHTML =
                `<textarea id="input_chattel_other" class="form-control" placeholder="Type Something">${this.value}</textarea>`;
    ...
    function addInputParkingSpot() {
        ...
        rowParkingSpots[0].querySelector('.labelParkingSpot').innerHTML =
            `<strong>Legal</strong> Description of Parking Spot 1`;
    ...
    function updateAllInputCustomers() {
        ...
        rowCustomers.forEach(function(rowCustomer) {
            if (indexRowCustomer != 0) {
                rowCustomer.querySelector('.labelCustomerName').innerHTML =
                    `${labelCustomerName_html} ${indexRowCustomer + 1}`;
                rowCustomer.querySelector('.labelCustomerName').setAttribute('for', `name${indexRowCustomer}`);
                rowCustomer.querySelector('.btnRemoveCustomer').setAttribute('onclick',
                    `removeInputCustomer('${indexRowCustomer}')`);
    ...
    function hideAllForms() {
        if (firstTimeHide == true) {
            ...
            form_booster.classList.remove('d-none');
        ...
        form_booster.style.display = 'none';
    ...
    function getValuesAllParkingSpots() {
        ...
        rowParkingSpots.forEach(function(rowParkingSpot) {
            var parking_spot_unit = rowParkingSpot.querySelector(
                'input[name="legal_description_parking_spot_unit"]').value;
            var parking_spot_level = rowParkingSpot.querySelector(
                'input[name="legal_description_parking_spot_level"]').value;
    ...
    function sendForm(final_target_form) {
        ...
        if (final_target_form == 'form_freehold_purchase_agreement') {
            ...
            if (legal_description_locker_unit.value == '' || legal_description_locker_level.value == '') {
                ...
                formData.append('legal_locker_number',
                    `(Unit ${legal_description_locker_unit.value}, Level ${legal_description_locker_level.value})`);
            }
            formData.append('chattels', getSelectedChattels());
            formData.append('agreement', 'Purchase Agreement');
    ...
    async function getMLSForms() {
        return new Promise(function(resolve, reject) {
            ...
            if (url_sext == true) {
                url +=
                    `https://bey18ckvn0.execute-api.ca-central-1.amazonaws.com/dev/FastOffersAPIGetBy_mls?mls=${mls_number.value}`;
            } else {
                        ...
                        if (this.status == 200) {
                            ...
                            if (response.hasOwnProperty('data')) {
                                if (Object.keys(response.data).length != 0) {
                                    ...
                                    if (response.data.hasOwnProperty('offer') && response.data
                                        .hasOwnProperty('property_class')) {
                                        ...
                                        let array_property_freehold = ['Freehold',
                                            'Att/Row/Twnhouse', 'Cottage', 'Detached', 'Duplex',
                                            'Farm', 'Fourplex', 'Link', 'Mobile/Trailer',
                                            'Multiplex', 'Other', 'Rural Resid',
                                            'Semi-Detached', 'Store W/Apt/Offc', 'Triplex',
                                            'Vacant Land'
                                        ];
                                        let array_property_condo = ['Condo', 'Comm Element Condo',
                                            'Condo Apt', 'Condo Townhouse', 'Co-Op Apt',
                                            'Co-Ownership Apt', 'Det Condo', 'Leasehold Condo',
                                            'Locker', 'Parking Space'
                                        ];
                                        let agreement = '';
                                        if (response.data.property_class == 'Freehold' && response
                                            .data.offer == 'Rent' || array_property_freehold
                                            .includes(response.data.property_class) && response.data
                                            .offer == 'Lease') {
                                        ...
                                        } else if (response.data.property_class == 'Freehold' &&
                                            response.data.offer == 'Sale' || array_property_freehold
                                            .includes(response.data.property_class) && response.data
                                            .offer == 'Sale' || array_property_freehold.includes(
                                                response.data.property_class) && response.data
                                            .offer == 'Sold') {
                                            agreement = 'Freehold Purchase Agreement';
                                            type.value = 'Freehold';
                                            if (url_sext == true) {
                                                legal_description_property.value = response.data
                                                    .legal_description;
                                            }
                                        ...
                                        } else if (response.data.property_class == 'Condo' &&
                                            response.data.offer == 'Rent' || array_property_condo
                                            .includes(response.data.property_class) && response.data
                                            .offer == 'Lease') {
                                            ...
                                            response.data.offer == 'Sale' || array_property_condo
                                            .includes(response.data.property_class) && response.data
                                            .offer == 'Sale' || array_property_condo.includes(
                                                response.data.property_class) && response.data
                                            .offer == 'Sold') {
                                            agreement = 'Condo Purchase Agreement';
                                            type.value = 'Condo';
                                            if (url_sext == true) {
                                                legal_description_condo_unit.value = response.data
                                                    .legal_unit;
                                                legal_description_condo_level.value = response.data
                                                    .legal_level;
                                                if (response.data.locker_unit == '') {
                                                    legal_description_locker_unit.value = response
                                                        .data.locker_number;
                                                } else {
                                                    legal_description_locker_unit.value = response
                                                        .data.locker_unit;
                                                }
                                                legal_description_locker_level.value = response.data
                                                    .locker_level;
                                            }
                                            labelCustomerName_html = 'Full Legal Name of Buyer';
                                            labelTypeCustomer_html = 'Buyer';
                                            ...
                                            if (response.data.parking_spots != 0) {
                                                divLegalDescriptionParkingSpot.style.display =
                                                    'block';
                                                for (var x = p = 0; p < response.data
                                                    .parking_spots - 1; p++) {
                                                    addInputParkingSpot();
                                                }
                                                if (url_sext == true) {
                                                    if (response.data.parking_unit == '') {
                                                        document.getElementById(
                                                                'legal_description_parking_spot_unit_0'
                                                            ).value = response.data
                                                            .parking_number;
                                                    } else {
                                                        document.getElementById(
                                                            'legal_description_parking_spot_unit_0'
                                                        ).value = response.data.parking_unit;
                                                    }

                                                    document.getElementById(
                                                        'legal_description_parking_spot_level_0'
                                                    ).value = response.data.parking_level;
                                                }
                                            }

                                            if (response.data.has_locker != 0 && response.data
                                                .has_locker != 'Ensuite' && response.data
                                                .has_locker != 'Common' && response.data
                                                .has_locker != 'None') {
                                        ...
                                        divCustomer.querySelectorAll('.rowCustomer')[0]
                                            .querySelector(`.labelCustomerName`).innerHTML =
                                            labelCustomerName_html;
                                        divCustomer.querySelectorAll('.rowCustomer')[0]
                                            .querySelector(`.btn`).setAttribute('title',
                                                `Add ${labelTypeCustomer_html}`);
